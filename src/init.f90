...
! along with this program; if not, see https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html
	...
	integer :: tmcs, tmcs_eq, n_speci_incl, sc(3), sample, samplei, &
        ...
        real(dp) :: temp, ht, lt, tint, dphi, to_cal, g_factor, para_value, &
        ...
        integer, allocatable :: ionn(:), nn(:,:,:,:), bblx(:), bbly(:), bblz(:), seed(:)
	...
	logical :: staggered, angle, Zeeman, single_ion_anisotropy, para, ovrr, &
