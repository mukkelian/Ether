...
! along with this program; if not, see https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html
	...
	subroutine write_nbd
		...
		write(10006, *) "'starting_spin_conf.xsf' as file > Open Structure > Open XSF > starting_spin_conf.dat."
		write(10006, *) "Check nbd's details by clicking the <Atom Info> (at bottom) and see the 'Selected Atom No.' informations. "
		write(10006, *) ''
		...
		nbd_inf : do i = 1, sc(1) + 2*nbd_cell_x
				do j = 1, sc(2) + 2*nbd_cell_y
					do k = 1, sc(3) + 2*nbd_cell_z
						...
						write(10006,10) int(ion(0, i, j, k, l))
						write(10006,*)"~~~~~~~~~~~~~~"
