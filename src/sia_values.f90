...
! along with this program; if not, see https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html
	...
	subroutine sia_values
		...
		if(file_found) then
			...
			if (rank == 0) write(6, *) ''
			do i = 1, nspecies
				read(10011, *) atom1, sia(1:3)	! Single Ion Anisotropy (SIA) vector in unit of meV
				sia_vec(1:3, i) = sia(1:3)
				ab = atom1
