...
! along with this program; if not, see https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html
	...
	write(6, *) '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
	write(6, *) ''
        write(6, '(I4,1x,I4,1x,I4,"  (Lx, Ly, Lz) <==> super cell size")') sc
	...
	write(6, *)'==> Spins are set in random configurations'
        ...
        if((angle.eqv..FALSE.).and.(model.eq.'h')) then
	...
	if(model.eq.'i') then
        ...
        if ((ovrr.eqv..TRUE.).and.(model.ne.'i'))then
